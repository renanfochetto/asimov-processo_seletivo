...
export const STRINGS = {
  ...
  services: {
    ...
    list: [
      {
        title: 'Search engine\noptimization',
        illustration: '/assets/illustrations/service-seo.svg',
        background: 'light',
      },
      {
        title: 'Pay-per-click\nadvertising',
        illustration: '/assets/illustrations/service-ppc.svg',
        background: 'green',
        badgeBg: '#FFFFFF',
        badgeText: '#191A23',
      },
      {
        title: 'Social Media\nMarketing',
        illustration: '/assets/illustrations/service-social.svg',
        background: 'dark',
        badgeBg: '#FFFFFF',
        badgeText: '#191A23',
      },
      {
        title: 'Email\nMarketing',
        illustration: '/assets/illustrations/service-email.svg',
        background: 'light',
      },
      {
        title: 'Content\nCreation',
        illustration: '/assets/illustrations/service-content.svg',
        background: 'green',
        badgeBg: '#FFFFFF',
        badgeText: '#191A23',
      },
      {
        title: 'Analytics and\nTracking',
        illustration: '/assets/illustrations/service-analytics.svg',
        background: 'dark',
      },
    ] as const,
  },
